...
public class TokenServiceServiceLocator extends org.apache.axis.client.Service
		implements pro.artse.tokenserver.services.TokenServiceService {
	...
	public TokenServiceServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
	...
	public pro.artse.tokenserver.services.TokenService getTokenService(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			pro.artse.tokenserver.services.TokenServiceSoapBindingStub _stub = new pro.artse.tokenserver.services.TokenServiceSoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (pro.artse.tokenserver.services.TokenService.class.isAssignableFrom(serviceEndpointInterface)) {
				pro.artse.tokenserver.services.TokenServiceSoapBindingStub _stub = new pro.artse.tokenserver.services.TokenServiceSoapBindingStub(
						new java.net.URL(TokenService_address), this);
				_stub.setPortName(getTokenServiceWSDDServiceName());
				return _stub;
			}
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName("http://services.tokenserver.artse.pro", "TokenServiceService");
	}
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName("http://services.tokenserver.artse.pro", "TokenService"));
		}
